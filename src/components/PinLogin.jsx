    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10 space-y-2">
          ...
          <h1 className="text-2xl font-bold text-white font-['Teko'] uppercase tracking-wider">Restricted Access</h1>
          <p className="text-zinc-500 text-xs font-mono uppercase tracking-widest">Authorization Required</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="relative group">
            <input
              ...
              className={`w-full bg-zinc-900/50 border text-center text-lg font-mono tracking-[0.5em] py-4 rounded-lg outline-none transition-all
          ...
          <button
            ...
            className={`w-full py-3 rounded-lg font-bold text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2
              ${!pin || isSubmitting ? 'bg-zinc-900 text-zinc-600 cursor-not-allowed' : 'bg-white text-black hover:bg-fuchsia-500 hover:text-white hover:shadow-[0_0_20px_rgba(217,70,239,0.3)]'}`}
          >
        ...
        <div className="mt-8 text-center">
          <p className="text-[9px] text-zinc-700 uppercase tracking-widest font-mono">Secure Environment v2.0</p>
        </div>
      </div>
    </div>
  );
