...
const TeamRoster = () => {
  ...
  // Mock Data
  const teams = [
    { id: 't1', name: 'Natus Vincere', tag: 'NAVI', captain: 'Aleksib', players: ['b1t', 'jL', 'iM', 'w0nderful'] },
    { id: 't2', name: 'FaZe Clan', tag: 'FAZE', captain: 'karrigan', players: ['rain', 'broky', 'ropz', 'frozen'] },
    { id: 't3', name: 'Team Vitality', tag: 'VIT', captain: 'apEX', players: ['ZywOo', 'Spinx', 'flameZ', 'mezii'] },
    { id: 't4', name: 'G2 Esports', tag: 'G2', captain: 'Snax', players: ['m0NESY', 'NiKo', 'huNter-', 'malbsMd'] },
  ];
