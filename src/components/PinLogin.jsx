      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
            <input 
                type="password"
                inputMode="numeric"
                className="w-full bg-slate-950 border border-slate-700 rounded-lg p-4 text-center text-2xl tracking-[0.5em] text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all placeholder:tracking-normal"
                placeholder="••••"
                value={pin}
