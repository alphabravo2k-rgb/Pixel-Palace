...
const Bracket = ({ onMatchClick }) => {
  const { matches, teams, loading, error } = useTournament(); // Get Error
      ...
      return (
          <div className="flex flex-col items-center justify-center h-[500px] text-red-500 gap-4">
              ...
              <div className="text-center">
                  <p className="text-sm font-bold tracking-widest">DATA SYNC FAILED</p>
                  <p className="text-xs font-mono mt-2 bg-red-900/20 p-2 rounded">{error}</p>
              </div>
          </div>
      );
  }
