...
const VetoPanel = ({ match }) => {
  ...
  const nextAction = "BAN"; // Ideally dynamic from backend based on veto step
          ...
          return (
            <button
             ...
             className={`
              ...
              `}
            >
              {map.image && <img src={map.image} alt={map.name} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />}
