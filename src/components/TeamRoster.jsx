...
import { Search, MessageCircle, Shield, RefreshCw, Pin, Crown, AlertTriangle } from 'lucide-react';
...
// --- BRANDED ICONS & SOCIALS (Restored from your old code) ---
const Icons = {
  Faceit: ({ className }) => (
