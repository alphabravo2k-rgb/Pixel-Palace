...
export const can = (capability, session, context = null) => {
  ...
  // 3. OWNER Override (Verified by Session Hydration, not Client String)
  // We trust this because session.role comes from our secure SQL view.
